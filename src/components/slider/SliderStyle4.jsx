  ...
  return (
    <div>
      <section className="flat-title-page style3 mainslider">
        <img className="bgr-gradient gradient1" src={shape1} alt="picture" />
        <img className="bgr-gradient gradient2" src={shape2} alt="picture" />
        <img className="bgr-gradient gradient3" src={shape3} alt="picture" />
