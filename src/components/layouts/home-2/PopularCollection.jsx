            ...
            <Link to="/authors-02">
              <div className="media-images-box">
                <div className="top-media">
                  <img src={props.item.imgleft} alt="picture" />
                  <img src={props.item.imgright3} alt="picture" />
                </div>
                <div className="bottom-media">
                  <img src={props.item.imgright1} alt="picture" />
                  <img src={props.item.imgright2} alt="picture" />
                  <img src={props.item.imgright4} alt="picture" />
                </div>
              </div>
            </Link>
