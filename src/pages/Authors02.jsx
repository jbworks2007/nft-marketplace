...
const Authors02 = () => {
  ...
  //const address = "0xe74Fd5655Bfc5dC0a0efB4ffcAD674619D453380";
  //const address = "0x17B42894364D09af01e7647526225EC23E1f1e3b";
  ...
  //let walletaddress;
  const walletAddres = async () => {
    setwallet(await signer.getAddress());
  };
  walletAddres();
  console.log("wallet add ouside", wallet);
          ...
          <div className="flat-tabs tab-authors">
            <div className="author-profile flex">
              <div className="feature-profile">
                {data && data.length > 0 ? (
                  <img
                    src={JSON.parse(data[0].metadata).image}
                    alt="picture"
                    className="avatar"
                  />
                ) : null}
                                ...
                                <div className="meta-info">
                                  <div className="author">
                                    <div className="avatar">
                                      <img src={data.imgAuthor} alt="picture" />
                                    </div>
                                    <div className="info">
                                      <span>{data.name}</span>
                                      <h6>
                                  ...
                                  <div className="tags">{data.token_id}</div>
                                </div>
